...
public class TodoContract {
    ...
    public static class TodoEntry implements BaseColumns {
        ...
        public static final String[] ALL_COLUMNS = {_ID, COL_TODO_TITLE, COL_TODO_DESCRIPTION, COL_TODO_DUE_DATE_TIME, COL_TODO_FAVOURITE, COL_TODO_COMPLETED, COL_TODO_CONTACT_IDS};
    }
}
